 ...
 */
if(!function_exists('mixtape_qodef_add_meta_box')) {
    /**
     * Adds new meta box
     *
     * @param $attributes
     ...
     */
    function mixtape_qodef_add_meta_box($attributes) {
        $scope = array();
        $title = '';
        $hidden_property = '';
        $hidden_values = array();
...
if(!function_exists('mixtape_qodef_add_meta_box_field')) {
    /**
     ...
     * @return bool|MixtapeQodeField
     */
    function mixtape_qodef_add_meta_box_field($attributes) {
        $type            = '';
        $name            = '';
        $default_value   = '';
        $label           = '';
