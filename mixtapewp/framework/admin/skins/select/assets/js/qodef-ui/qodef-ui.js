(function($){
    ...
    function qodefChangedInput () {
        ...
        $('.qodef-tabs-content form.qodef_ajax_form:not(.qodef-import-page-holder):not(.qodef-backup-options-page-holder) .field.switch label:not(.selected)').click( function() {
            $('.qodef-input-change').addClass('yes');
        });

        $('.qodef-tabs-content form.qodef_ajax_form:not(.qodef-import-page-holder):not(.qodef-backup-options-page-holder) #anchornav input').click(function() {
            ...
            frame: function() {
                ...
                this._frame.on('update', function() {
                    ...
                    jQuery.ajax({
                        type: "post",
                        url: ajaxurl,
                        data: "action=mixtape_qodef_gallery_upload_get_images&ids=" + ids,
