<div class="qodef-tabs-navigation-wrapper">
    <ul class="nav nav-tabs">
        ...
        ?>
	    <?php if (mixtape_qodef_core_plugin_installed()) { ?>
			<li <?php if($is_backup_options_page) { echo "class='active'"; } ?>><a href="<?php echo esc_url(get_admin_url().'admin.php?page=mixtape_qodef_theme_menu_backup_options'); ?>"><i class="fa fa-download qodef-database qodef-tooltip qodef-inline-tooltip left" data-placement="top" data-toggle="tooltip" title="<?php esc_html_e('Backup Options','mixtapewp'); ?>"></i><span><?php esc_html_e('Backup Options','mixtapewp'); ?></span></a></li>
			<li <?php if($is_import_page) { echo "class='active'"; } ?>><a href="<?php echo esc_url(get_admin_url().'admin.php?page=mixtape_qodef_theme_menu_tabimport'); ?>"><i class="fa fa-download qodef-tooltip qodef-inline-tooltip left" data-placement="top" data-toggle="tooltip" title="<?php esc_html_e('Import', 'mixtapewp'); ?>"></i><span><?php esc_html_e('Import', 'mixtapewp'); ?></span></a></li>
	    <?php } ?>
    </ul>
</div>