									...
									<li>
										...
										<div class="qodef-item-info-holder">
                                            ...
                                            <div class="qodef-item-right">
												<?php echo apply_filters('woocommerce_cart_item_remove_link', sprintf('<a href="%s" class="remove" title="%s">&times;</a>', esc_url($woocommerce->cart->get_remove_url($cart_item_key)), esc_html__('Remove this item', 'mixtapewp')), $cart_item_key); ?>
...
add_action( 'widgets_init', create_function( '', 'register_widget( "MixtapeQodeWoocommerceDropdownCart" );' ) );
?>
<?php
