<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="qodef-post-content">
		<?php if(get_post_meta(get_the_ID(), "qodef_audio_post_type_meta", true) == 'self' || get_post_meta(get_the_ID(), "qodef_audio_post_type_meta", true) == ''){
				mixtape_qodef_get_module_template_part('templates/lists/parts/image', 'blog', '', $params);
				if(get_post_meta(get_the_ID(), "qodef_post_audio_link_meta", true) !== ""){
