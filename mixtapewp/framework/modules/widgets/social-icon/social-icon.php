 ...
 */
class MixtapeQodeSocialIconWidget extends MixtapeQodeWidget {
    /**
     * Set basic widget options and call parent class construct
     */
    public function __construct() {
        parent::__construct(
            'qodef_social_icon_widget', // Base ID
            esc_html__('Select Social Icon Widget','mixtapewp') // Name
        );
    ...
    protected function setParams() {
        $this->params = array_merge(
            mixtape_qodef_icon_collections()->getSocialIconWidgetParamsArray(),
            array(
                array(
                    'type' => 'textfield',
                    'title' => esc_html__('Link','mixtapewp'),
                    'name' => 'link',
                    'description' => ''
                ),
                array(
                    'type' => 'dropdown',
                    'title' => esc_html__('Target','mixtapewp'),
                    'name' => 'target',
                    'options' => array(
                        '_self' => esc_html__('Same Window','mixtapewp'),
                        '_blank' => esc_html__('New Window','mixtapewp')
                    ),
                    'description' => ''
                ),
                array(
                    'type' => 'textfield',
                    'title' => esc_html__('Text Size (px)','mixtapewp'),
                    'name' => 'text_size',
                    'description' => ''
                ),
                array(
                ...
                array(
                    'type' => 'textfield',
                    'title' => esc_html__('Hover Color','mixtapewp'),
                    'name' => 'hover_color',
                    'description' => ''
                ),
                array(
    ...
    public function widget($args, $instance) {
        ...
        <a class="qodef-social-icon-widget-holder" <?php echo mixtape_qodef_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php mixtape_qodef_inline_style($social_icon_styles) ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
