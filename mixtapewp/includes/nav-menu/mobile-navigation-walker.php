...
if (!class_exists('MixtapeQodeMobileNavigationWalker')) {
	class MixtapeQodeMobileNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				if($item->nolink == ""){
					...
					$item_output .= '<a href="javascript:void(0)" class="qodef-mobile-menu-no-link">';
				}
