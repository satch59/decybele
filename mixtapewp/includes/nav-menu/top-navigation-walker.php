 ...
 */
if (!class_exists('MixtapeQodeTopNavigationWalker')) {
	class MixtapeQodeTopNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				$item_output .= '</span></a>'; //close span.qodef-item-outer
			}
